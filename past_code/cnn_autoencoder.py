...
# output dir
os.makedirs('reconstructed_image_CNN_50epoch', exist_ok=True)
...
for latent_dim in latent_dims:
    ...
    plt.tight_layout()
    plt.savefig(f'reconstructed_image_CNN_50epoch/reconstructed_grid_latent_{latent_dim}.png')
    plt.close()
...
plt.grid(True)
plt.savefig("reconstructed_image_CNN_50epoch/reconstruction_error_plot.png")
plt.close()
